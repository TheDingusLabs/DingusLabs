...
public class Ball : MonoBehaviour
{
    ...
    private PhysicsPlaygroundAgent player;

    private PhysicsPlaygroundRoom room;
    ...
    void Start() 
    {
        ...
        room = roomGO.GetComponent<PhysicsPlaygroundRoom>();

        //Debug.Log(this.transform.parent.parent.name);
        player = this.transform.parent.parent.Find("Agent").GetComponent<PhysicsPlaygroundAgent>();
